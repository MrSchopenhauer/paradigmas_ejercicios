...
public class CarreraInicio {
    ...
    public static void main(String[] args) {
        ...
        // CUARTO POR SI ACASO
        Corredor corredor4 = new Corredor(0,350,4);
        ...
        Thread hiloCorredor2 = new Thread(new HiloCorredorP2(corredor2, panel, corredor1,finP1,finP4));
        Thread hiloCorredor3 = new Thread(new HiloCorredorP3(corredor3, panel, corredor1,finP1,finP4));
        Thread hiloCorredor4 = new Thread(new HiloCorredorP4(corredor4,panel, corredor2, finP4));
